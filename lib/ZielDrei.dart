...
class ZielDrei extends StatefulWidget {
  @override
  _ZielDreiState createState() => _ZielDreiState();
}

class _ZielDreiState extends State<ZielDrei> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      _interestButton('Diät'),
                      _interestButton('Trainieren'),
                      _interestButton('Training und Diät'),
